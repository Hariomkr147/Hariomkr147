...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=500&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=700&lines=Building+AI-powered+products;Designing+LLM+workflows+with+grounding+and+validation;Shipping+full-stack+systems+with+clean+APIs;Data+Science+%40+IIT+Madras" alt="Typing SVG" /></a>
...
[![Email](https://img.shields.io/badge/Email-Contact%20Me-4C1D95?style=for-the-badge&logo=gmail&logoColor=white)](mailto:hari18525@gmail.com)
...
- 🎓 Data Science and Applications student at **IIT Madras**, with a strong focus on software engineering, AI/ML, and full-stack product development.
- 🤖 Build **LLM-orchestrated systems** with multi-provider routing, retrieval-augmented generation (RAG), and grounding/validation pipelines.
- 🧩 Deliver **full-stack applications** end-to-end using Flask, FastAPI, React, Vue.js, REST APIs, SQLAlchemy, and relational databases.
- 📊 Apply a **product and analytics mindset** through feature engineering, forecasting, data analysis, and BI-style reporting.
- ⚙️ Comfortable across database design, backend architecture, workflow automation, and Git-based collaboration.
- 🌱 Continuously exploring generative AI, cloud computing, and scalable data systems through coursework and projects.

**🎯 Open To:** Software Engineering · AI/ML Engineering · Full-Stack Development · Data Science Roles & Internships
...
|---|---|---|
| LLM Orchestration | ⭐⭐⭐⭐☆ | Multi-provider routing with role-based model selection, retry/failover handling, and structured execution flows |
| Retrieval-Augmented Generation (RAG) | ⭐⭐⭐⭐☆ | Source-grounded pipelines with claim matching and validation to reduce hallucinations |
| Machine Learning | ⭐⭐⭐⭐☆ | Scikit-learn, XGBoost, LightGBM, forecasting, regression, and feature engineering |
| Prompt Engineering | ⭐⭐⭐⭐☆ | Role-based prompts, structured outputs, and schema-constrained generation |
| Multi-Agent Systems | ⭐⭐⭐☆☆ | Coordinator-style patterns for extractor, planner, generator, and auditor roles |
| Data Analysis & BI | ⭐⭐⭐⭐☆ | Excel financial modeling, pivot tables, Power BI dashboards, and KPI analysis |
...
Transforms educational documents into structured, source-grounded Teacher Knowledge Packages, including lesson plans, classroom activities, assessments, and misconception analysis.
...
| **Performance** | SSE-based live progress streaming and disk-cached LLM responses |
| **Security** | Origin-tagged content with two-pass grounding and hallucination checks |
| **Impact** | Converts a chapter upload into a teacher-ready package in minutes |
| **Repository** | [github.com/Hariomkr147/Gyantra](https://github.com/Hariomkr147/Gyantra) |

Built as a fixed, auditable pipeline instead of a general-purpose agent framework so each stage can fail gracefully while critical checks still block bad outputs.
...
Machine learning project to forecast cinema audience demand from historical sales and attendance data.

| Aspect | Detail |
|---|---|
| **Stack** | Python, Pandas, NumPy, Scikit-learn, Matplotlib |
| **Scale** | Multi-feature historical dataset with engineered demand indicators |
| **Performance** | Benchmarked multiple regression and classification models for forecast accuracy |
| **Security** | Input validation and preprocessing checks for data consistency |
| **Impact** | Produced actionable forecasts for scheduling and inventory decisions |
...
Role-based placement management platform for Admin, Company, and Student workflows.
...
| **Impact** | Streamlined campus recruitment operations |
...
Business analytics case study built around cleaning raw sales data and turning it into strategic recommendations.

| Aspect | Detail |
|---|---|
| **Stack** | Excel (Pivot Tables, Financial Modeling), Power BI |
| **Scale** | 61 days of unstructured sales/pricing data across 5 SKUs |
| **Performance** | Automated revenue, profitability, and fixed-cost calculations |
| **Security** | N/A — offline business dataset |
| **Impact** | Profitability benchmarking informed pricing and diversification recommendations |
...
[![Gmail](https://img.shields.io/badge/Gmail-hari18525%40gmail.com-4C1D95?style=for-the-badge&logo=gmail&logoColor=white)](mailto:hari18525@gmail.com)
